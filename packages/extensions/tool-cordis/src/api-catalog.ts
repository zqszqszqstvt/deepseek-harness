  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        parameters: [{ name: 'target', description: 'the resolved target to stat.' }, { name: 'signal', description: 'aborts the metadata round-trip.' }, { name: 'sandboxPolicy', description: 'optional per-call workspace boundary for a sandboxing backend.' }],
      ...
      },
      {
        ...
        parameters: [{ name: 'target', description: 'the resolved target to read.' }, { name: 'signal', description: 'aborts the read.' }, { name: 'sandboxPolicy', description: 'optional per-call workspace boundary for a sandboxing backend.' }],
      ...
      },
      {
        ...
        parameters: [{ name: 'target', description: 'the resolved target to read.' }, { name: 'signal', description: 'aborts the stream, including between chunks.' }, { name: 'sandboxPolicy', description: 'optional per-call workspace boundary for a sandboxing backend.' }],
      ...
      },
      {
        ...
        parameters: [{ name: 'target', description: 'the resolved directory target.' }, { name: 'signal', description: 'aborts the listing.' }, { name: 'sandboxPolicy', description: 'optional per-call workspace boundary for a sandboxing backend.' }],
