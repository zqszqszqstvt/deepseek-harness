...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  serverEnvironments: 'server.md',
  serverRuntimeRouter: 'server.md',
  serverStartup: 'server.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExecutorBrokerExecuteOptions: 'Server-local Broker options are owned by packages/bundle/server/README.md',
  ExecutorBrokerRequest: 'Server-local Broker request fields are owned by packages/bundle/server/README.md',
  ExecutorOperation: 'executor wire operations are owned by packages/executor/executor-protocol/README.md',
  ExecutorResultMessage: 'executor wire results are owned by packages/executor/executor-protocol/README.md',
  LocalExecutorRegistration: 'Server-local device registration is owned by packages/bundle/server/README.md',
  ProjectEnvironmentsView: 'Server-local environment projection is owned by packages/bundle/server/README.md',
  ProjectSessionState: 'Server-local project Session state is owned by packages/bundle/server/README.md',
  ServerBindingId: 'Server-local environment identity is owned by packages/bundle/server/README.md',
  ServerRuntimeSelection: 'Server-local routing snapshot is owned by packages/bundle/server/README.md',
